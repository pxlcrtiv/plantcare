...
- **#9 First verified run is now unblocked** (blockers final: baseline ✓ firebase ✓ key ✓) — next frontier. Needs a run-target decision: which emulator/simulator exists on this machine (fog: AVDs unverified).
