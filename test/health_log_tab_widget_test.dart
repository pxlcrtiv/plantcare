...
void main() {
  ...
  group('HealthLogTabWidget summary', () {
    ...
    for (final (error, title, body) in [
      (
        const QuotaExceededError('quota exhausted'),
        'The assistant is resting',
        'Try again in a moment.',
      ),
      (
        const BlockedError('blocked for safety'),
        'The assistant could not answer',
        'Try rephrasing or summarize again.',
      ),
      (
        const TimeoutError('took too long'),
        'The assistant took too long',
        'Try again in a moment.',
      ),
      (
        const MalformedOutputError('bad output'),
        'The assistant is resting',
        'Try again in a moment.',
      ),
      (
        const OfflineError('offline'),
        "You're offline",
